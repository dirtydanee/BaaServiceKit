...
extension KeyedDecodingContainer {
    ...
    func decodeD(_ type: Dictionary<String, Any>.Type, forKey key: K) throws -> Dictionary<String, Any> {
    ...
    func decode(_ type: Dictionary<String, Any>.Type) throws -> Dictionary<String, Any> {
        ...
        for key in allKeys {
            ...
            } else if let nestedDictionary = try? decodeD(Dictionary<String, Any>.self, forKey: key) {
    ...
    mutating func encode(_ value: Array<Any>) throws {
        try value.enumerated().forEach({ (index, value) in
            ...
            default:
                ...
                throw EncodingError.invalidValue(value, EncodingError.Context(codingPath: codingPath + keys,
                                                                              debugDescription: "Invalid JSON value"))
            }
        })
    }
