...
public struct Proof: Codable {
    ...
    let type: String
    let hash_id_node: String
//    let hash_submitted_node_at: String // Date
    let hash_id_core: String
//    let hash_submitted_core_at: String // Date
    
    enum CodingKeys: String, CodingKey {
        case hash = "hash"
        case context = "@context"
        case type = "type"
        case hash_id_node = "hash_id_node"
//        case hash_submitted_node_at = "hash_submitted_node_at"
        case hash_id_core = "hash_id_core"
//        case hash_submitted_core_at = "hash_submitted_core_at"
    }
}
